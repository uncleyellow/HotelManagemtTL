...
namespace HotelManagementDA.Controllers
{
    ...
    public class RoomBookingController : ControllerBase
    {
        ...
        {
            string query = $@"Select id, name, email, phoneNumber, checkInDate,checkOutDate, kindOfRoom, roomNumber, description, status, price from roomBooking letter name LIKE '%{keyword}%'";
